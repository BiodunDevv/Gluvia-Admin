...
import type { Admin } from "@/stores/useAdminStore";
...
// Admin detail viewer component
function AdminDetailViewer({
  admin,
  onEdit,
  onDeactivate,
  onActivate,
    ...
    <Drawer direction={isMobile ? "bottom" : "right"}>
      ...
      <DrawerContent className="max-h-[90vh]">
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>{admin.email}</DrawerDescription>
        </DrawerHeader>
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
          {/* Status & Role */}
          <div className="flex items-center gap-2 flex-wrap">
            <Badge variant={admin.deleted ? "destructive" : "default"}>
              {admin.deleted ? "Deactivated" : "Active"}
            </Badge>
            <Badge
              variant="secondary"
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-lg bg-purple-50 p-3">
                ...
                <p className="font-semibold capitalize mt-1 text-purple-700">
                  Administrator
                </p>
              </div>
